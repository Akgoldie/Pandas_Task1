"""
Read the student.CSV file by using Pandas
a)	All Rows
b)	First 5 rows
c)	Last 5 rows
...
g)	Print student details who scored > 50 and gender = ‘male’.
"""
import  pandas as pd

data=pd.read_csv("C:\\Users\\91962\\Downloads\\student_csv.csv")
...
print(df.loc[(df['mark']>50) & (df['gender']=="male")])
